    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-20 gap-8">
        ...
        <a 
          ...
          className="flex items-center px-6 py-3 bg-white text-black text-xs font-bold uppercase tracking-widest hover:bg-emerald-500 hover:text-white transition-all rounded"
        >
        ...
        <div className="space-y-16">
          {data.cv.experience.map((item) => (
            <div key={item.id} className="group">
              ...
              <p className="text-emerald-500/80 text-sm font-bold uppercase tracking-widest mb-4">{item.institution}</p>
