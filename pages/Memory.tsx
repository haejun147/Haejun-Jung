  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
      <div className="mb-20">
        ...
        <div className="h-1 w-20 bg-[#2DD4BF] mb-6"></div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
        {data.memories.map((post) => (
          <div key={post.id} className="group border border-white/5 rounded-lg overflow-hidden bg-zinc-900/30 transition-all hover:border-[#2DD4BF]/20">
            ...
            <div className="p-8">
              <div className="flex items-center text-zinc-600 text-[10px] font-bold uppercase tracking-widest mb-4">
                <Calendar size={10} className="mr-2 text-[#2DD4BF]" /> {post.date}
              </div>
              <h3 className="text-lg font-bold text-white mb-4 group-hover:text-[#2DD4BF] transition-colors">
                {post.title}
              </h3>
